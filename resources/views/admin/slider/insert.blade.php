            ...
            <form id="demo-form2" method="post" action="{{url('slider/')}}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-4">
                  ...
                  <br>
                  <small class="text-muted"><i class="fa fa-question-circle"></i> Recommended image size (1375 x 409px)</small>
                ...
                <div class="col-md-4">
                  <label for="exampleInputDetails">{{ __('adminstaticword.TextPosition') }}:</label>
                  <br>
                  <li class="tg-list-item">              
                    <input class="tgl tgl-skewed" id="left" type="checkbox" name="left" >
                    <label class="tgl-btn" data-tg-off="Left" data-tg-on="Right" for="left"></label>
                  </li>

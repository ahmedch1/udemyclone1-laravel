    ...
    <section class="sidebar">
      ...
      @if(Auth::User()->role == "admin")
       ...
       @endif
          ...
          <li class="{{ Nav::isRoute('onesignal.settings') }}"><a href="{{route('onesignal.settings')}}"><i class="fa fa-location-arrow" aria-hidden="true"></i><span>{{ __('Push Notification') }}</span></a></li>
          ...
          <li class="{{ Nav::isRoute('gen.set') }} {{ Nav::isRoute('api.setApiView') }} {{ Nav::isResource('blog') }} {{ Nav::isRoute('about.page') }} {{ Nav::isRoute('careers.page') }} {{ Nav::isRoute('comingsoon.page') }} {{ Nav::isRoute('termscondition') }} {{ Nav::isRoute('policy') }} {{ Nav::isRoute('bank.transfer') }} {{ Nav::isRoute('show.pwa') }} {{ Nav::isRoute('adsense') }} {{ Nav::isRoute('ipblock.view') }} {{ Nav::isRoute('whatsapp.button') }} {{ Nav::isRoute('coloroption.view') }} {{ Nav::isResource('manualpayment') }} {{ Nav::isRoute('twilio.settings') }} treeview">
           <a href="#">
            ...
            <ul class="treeview-menu">
              ...
              <li class="{{ Nav::isRoute('twilio.settings') }}"><a href="{{route('twilio.settings')}}" title="Whatsapp Button Setting"><span><i class="fa fa-comment-o" aria-hidden="true"></i>&emsp; {{ __('Twilio Settings') }}</span></a></li>
          ...
          <li class="{{ Nav::isRoute('activity.index') }}"><a href="{{route('activity.index')}}"><i class="fa fa-clone" aria-hidden="true"></i><span>{{ __('Activity Log') }}</span></a></li>
          ...
          <li class="{{ Nav::isRoute('import.view') }} {{ Nav::isRoute('database.backup') }} {{ Nav::isRoute('update.process') }} {{ Nav::isRoute('quick.update') }} treeview">
           <a href="#">
            ...
            <ul class="treeview-menu">
              ...
              <li class="{{ Nav::isRoute('quick.update') }}"><a href="{{route('quick.update')}}"><i class="fa fa-spinner" aria-hidden="true"></i><span>{{ __('Quick Update') }}</span></a></li>

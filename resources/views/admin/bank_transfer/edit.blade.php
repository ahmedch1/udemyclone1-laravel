						...
						<br>
		                  ...
		                  <div class="col-md-8 col-md-offset-2">
		                  	<div class="form-group">
			                    ...
			                    <input value="{{ optional($show)->account_holder_name }}" name="account_holder_name" type="text" class="form-control" placeholder="Enter account name" required autocomplete="off"/>
			                </div>
		                  </div>
		                  ...
		                  <div class="col-md-8 col-md-offset-2">
		                  	<div class="form-group">
			                    ...
			                    <input value="{{ optional($show)->bank_name }}" name="bank_name" type="text" class="form-control" placeholder="Enter bank name" required autocomplete="off"/>
			                </div>
		                  </div>
		                  ...
		                  <div class="col-md-8 col-md-offset-2">
		                  	<div class="form-group">
			                    ...
			                    <input value="{{ optional($show)->account_number }}" name="account_number" type="text" class="form-control" placeholder="Enter account number" required autocomplete="off"/>
			                </div>
		                  </div>
		                  ...
		                  <div class="col-md-8 col-md-offset-2">
		                  	<div class="form-group">
			                    ...
			                    <input value="{{ optional($show)->ifcs_code }}" name="ifcs_code" type="text" class="form-control" placeholder="Enter IFCS code" autocomplete="off"/>
			                </div>
		                  </div>
		                  ...
		                  <div class="col-md-8 col-md-offset-2">
		                  	<div class="form-group">
			                    ...
			                    <input value="{{ optional($show)->swift_code }}" name="swift_code" type="text" class="form-control" placeholder="Enter Swift Code" autocomplete="off"/>
			                </div>
		                  </div>

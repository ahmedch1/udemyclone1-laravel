                ...
                <form action="{{ route('player.update') }}" method="POST" enctype="multipart/form-data">
                       ...
                       <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <li class="tg-list-item">              
                              <input class="tgl tgl-skewed" id="cb4" type="checkbox" name="logo_enable" @if(isset($ps->logo_enable)) {{ $ps->logo_enable == '1' ? 'checked' : '' }} @endif/>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <br>  
                        <input type="file" name="logo" value="@if(isset($ps->logo)){{ $ps['logo'] }} @endif" id="logo" class="{{ $errors->has('logo') ? ' is-invalid' : '' }} inputfile inputfile-1"/>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          <label for="exampleInputDetails">{{ __('adminstaticword.ShareEnable') }}:</label>
                            <li class="tg-list-item">              
                              <input class="tgl tgl-skewed" id="cb3" type="checkbox" name="share_enable"  @if(isset($ps->share_enable)){{ $ps['share_enable'] == '1' ? 'checked' : '' }} @endif/>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          <label for="exampleInputDetails">{{ __('adminstaticword.AutoPlay') }}:</label>
                            <li class="tg-list-item">              
                              <input class="tgl tgl-skewed" id="cb6" type="checkbox" name="autoplay" @if(isset($ps->autoplay)) {{ $ps['autoplay'] == '1' ? 'checked' : '' }} @endif/>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          <label for="exampleInputDetails">Video Downlaod Enable:</label>
                            <li class="tg-list-item">              
                              <input class="tgl tgl-skewed" id="cb7" type="checkbox" name="download" @if(isset($ps->download)) {{ $ps['download'] == '1' ? 'checked' : '' }} @endif/>

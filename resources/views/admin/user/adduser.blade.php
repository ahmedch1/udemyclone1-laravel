          ...
          <form action="{{ route('user.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <textarea name="address" rows="2"  class="form-control" placeholder="Enter your address"></textarea>
              </div>
            ...
            <div class="row">
              <div class="col-md-3">
                <label for="exampleInputSlug">{{ __('adminstaticword.Image') }}: </label> <p class="inline info">size: 625x625</p>
                <br>

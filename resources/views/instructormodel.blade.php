                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="fname" id="title" placeholder="Please Enter First Name" value="{{Auth::User()->fname}}" required>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label for="lname">Last Name:<sup class="redstar">*</sup></label>
                          <input type="text" class="form-control" name="lname" id="title" placeholder="Please Enter Last Name" value="{{Auth::User()->lname}}" required>
                        </div>
                      </div>
                    </div>

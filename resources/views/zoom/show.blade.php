...
<section class="content">
	<div class="box">
		...
		<div class="box-body">
			...
			<hr>
			<h5><i class="fa fa-microphone" aria-hidden="true"></i> Audio : {{ isset($response['settings']['audio']) == 'both' ? "Computer and Internet call" : isset($response['settings']['audio']) }}</h5>
			<h5><i class="fa fa-camera" aria-hidden="true"></i> Host Video : {{ isset($response['settings']['host_video']) == true ? "Enabled" : "Disabled"}}</h5>
			<h5><i class="fa fa-group" aria-hidden="true"></i> Join before Host : {{ isset($response['settings']['join_before_host']) == true ? "Yes" : "No"}}</h5>
			<h5><i class="fa fa-group" aria-hidden="true"></i> Join before Host : {{ isset($response['settings']['join_before_host']) == true ? "Yes" : "No"}}</h5>
			<h5><i class="fa fa-group" aria-hidden="true"></i> Participant Video : {{ isset($response['settings']['participant_video']['join_before_host']) == true ? "Enabled" : "Disabled"}}</h5>
		</div>
